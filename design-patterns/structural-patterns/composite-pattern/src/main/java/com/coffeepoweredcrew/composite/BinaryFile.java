...
public class BinaryFile extends File {
    ...
    public File[] getFiles() {
        throw new UnsupportedOperationException("Leaf doesn't support get operation.");
    }

    @Override
    public boolean removeFile(File file) {
        throw new UnsupportedOperationException("Leaf doesn't support remove operation.");
    }
}
